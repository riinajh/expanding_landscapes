...
\begin{figure}[h!]
	\centering
	\subfloat[\label{prng} PRNG]{\includegraphics[width = 0.75\textwidth]{figures/prng.pdf}}
	\\
	\subfloat[\label{cbrng} CBRNG]{\includegraphics[width = 0.75\textwidth]{figures/cbrng.pdf}}
	\label{rngs}
...
\begin{figure}[h!]
	\centering
	\subfloat[\label{ad:sub1} Initial genome size 1]{\includegraphics[width = 0.33\textwidth]{figures/L20l1i1_20250902_1035.pdf}}
	\subfloat[\label{ad:sub2} Initial genome size 10]{\includegraphics[width = 0.33\textwidth]{figures/L20l10i1_20250902_1035.pdf}}
	\\
	\subfloat[\label{ad:sub3} Initial genome size 20]{\includegraphics[width = 0.33\textwidth]{figures/L20l20i1_20250902_1035.pdf}}
	\subfloat[\label{ad:sub4} Densities of genome size time series]{\includegraphics[width = 0.33\textwidth]{figures/random_walk_additive.pdf}}
...
\begin{figure}[h!]
	\centering
	\subfloat[\label{ul:sub1} Final fitnesses:\\ Static landscapes]{\includegraphics[width = 0.333\textwidth]{figures/05-2_static_finalfitness.pdf}}
	\subfloat[\label{ul:sub2} Final fitnesses:\\ Expanding landscapes \\($L_{\text{max}} = 20$)]{\includegraphics[width = 0.333\textwidth]{figures/06-1_expanding_initialsize_fitness.pdf}}
	\subfloat[\label{ul:sub3} Final fitnesses:\\ Expanding landscapes \\($L_{\text{max}} = 100$)]{\includegraphics[width = 0.333\textwidth]{figures/06-4_expanding_initialsizefitness_2.pdf}} \\
	\subfloat[\label{ul:sub4} Final size distributions \\($L_{\text{max}} = 20$)]{\includegraphics[width = 0.333\textwidth]{figures/06-3_expanding_initialfinalsize.pdf}}
	\subfloat[\label{ul:sub5} Final size distributions \\($L_{\text{max}} = 100$)]{\includegraphics[width = 0.333\textwidth]{figures/06-6_initialfinalsize_2.pdf}}
...
\begin{figure}[h!]
        \centering                                                                                                                                                  \subfloat[\label{ie:sub1} Fitness trajectories]{\includegraphics[width = 0.4\textwidth]{figures/genome_trajectories.pdf}}
        \subfloat[\label{ie:sub2} Endpoints]{\includegraphics[width = 0.4\textwidth]{figures/endpoint_boxplots.pdf}} \\                                             \subfloat[\label{ie:sub3} Size transition timings]{\includegraphics[width = 0.4\textwidth]{figures/timings.pdf}}                                            \subfloat[\label{ie:sub4} Endpoint comparisons on uncorrelated landscapes.]{\includegraphics[width = 0.4\textwidth]{figures/hoc_boxplots.pdf}}              \caption{\textit{(a)}: Fitness trajectories over different genome sizes, \textit{(b)}: fitness comparisons of endpoint and non-endpoint simulations at various genome sizes, \textit{(c)}: Distributions of generation times at which genome size transitions are made, \textit{(d)}: fitness comparisons as in \textit{(b)} on uncorrelated landscapes}
...
\begin{figure}[h!]
	\centering
	\subfloat[\label{uf:gt} Fitness trajectories for all simulations, not filtered for genome increasing replicates]{\includegraphics[width = 0.4\textwidth]{figures/genome_trajectories_unfiltered.pdf}}
	\subfloat[\label{uf:bp} Fitness comparisions of endpoint and non-endpoint simulations, unfiltered]{\includegraphics[width = 0.4\textwidth]{figures/endpoint_boxplots_unfiltered.pdf}}
	\caption{}
	\label{uf}
\end{figure}
